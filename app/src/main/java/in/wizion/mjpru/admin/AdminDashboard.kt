package `in`.wizion.mjpru.admin

import `in`.wizion.mjpru.R
import `in`.wizion.mjpru.common.SessionManager
import `in`.wizion.mjpru.admin.bottomNavigationFragments.ResultFragment
import `in`.wizion.mjpru.admin.bottomNavigationFragments.SyllabusFragment
import `in`.wizion.mjpru.admin.bottomNavigationFragments.AdminDashboardFragment
...
class AdminDashboard : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        supportFragmentManager.beginTransaction().replace(R.id.fragment_container, AdminDashboardFragment()).commit()
        bottomMenu()
        ...
        chipNavigationBar.setOnItemSelectedListener( object :
            ...
            override fun onItemSelected(id: Int) {
                val fragment : Fragment? = when(id){
                    ...
                    R.id.bottom_nav_dashboard -> AdminDashboardFragment()
