...
import `in`.wizion.mjpru.common.AdminModelClass
...
class VerifyOTP : AppCompatActivity() {
    ...
    private fun storeNewUsersData() {
        ...
        val addNewAdmin : AdminModelClass = AdminModelClass(_fullName,_username,_email,_phoneNo,_password,_date,_gender)
        reference.child(_phoneNo).setValue(addNewAdmin)
